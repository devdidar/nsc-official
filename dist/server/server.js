...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-LBngFOVq.js");
...
var manifest = { "8ea8690aaab80875cf482a126a44cd9f13ec49afc9b16a0316a32eb799705071": {
	functionName: "sendContactEmail_createServerFn_handler",
	importer: () => import("./assets/email-ghLBJ2hX.js")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-DXW0dJBx.js"),
		import("./assets/start-CPJLSwsk.js"),
