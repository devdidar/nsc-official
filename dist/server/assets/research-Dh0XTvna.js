...
import { t as Route } from "./research-BQ0c7Fw9.js";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Beaker, Database, FileText, GitBranch } from "lucide-react";
//#region src/routes/research.tsx?tsr-split=component
var tracks = [
	{
		i: FileText,
		t: "Papers & preprints",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsx("div", {
				...
				children: tracks.map(({ i: I, t, d }, k) => /* @__PURE__ */ jsxs(GlassCard, {
					"data-reveal": true,
			...
			/* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsx("div", {
				...
				children: papers?.map((p, i) => /* @__PURE__ */ jsxs("a", {
					href: p.link_url || "#",
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: p.status
							}), /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 opacity-60 transition-transform group-hover:translate-x-1" })]
						})
					]
				}, p.title))
			})] })
