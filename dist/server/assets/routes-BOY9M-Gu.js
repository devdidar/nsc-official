...
import { ArrowRight, Bot, CalendarDays, Code2, Cpu, FlaskConical, Mail, Microscope, Quote, Rocket, School, Sigma, Sparkles, Star, Telescope, Trophy, Users, Wrench } from "lucide-react";
...
function Hero() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsx(Blobs, {}),
			/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 grid-bg opacity-70" }),
			/* @__PURE__ */ jsx(FloatingCodeSnippets, {}),
			/* @__PURE__ */ jsx(FloatingGlyphs, {}),
			/* @__PURE__ */ jsx("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-gradient-primary animate-pulse-glow" }), /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("h1", {
							...
							children: ["Empowering Young Minds Through ", /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(CTAButton, {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: /* @__PURE__ */ jsx(Rocket, { className: "h-3 w-3" })
								}), "About Our Club"]
							})]
						}),
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx("div", {
								...
								children: Array.from({ length: 2 }).map((_, k) => /* @__PURE__ */ jsx("div", {
									...
									children: [
										...
										"Research",
										"Innovation"
									].map((x) => /* @__PURE__ */ jsx("span", { children: x }, x + k))
								}, k))
							})
						})
					]
...
function FloatingGlyphs() {
	return /* @__PURE__ */ jsx("div", {
		...
		].map(({ Icon, ...pos }, i) => /* @__PURE__ */ jsx("div", {
...
function Mission() {
	return /* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			className: "reveal",
			children: [
				/* @__PURE__ */ jsx(Eyebrow, { children: "Our mission" }),
				/* @__PURE__ */ jsxs("h2", {
			...
			children: /* @__PURE__ */ jsx("div", {
				...
				].map(({ icon: I, k, v }) => /* @__PURE__ */ jsxs(GlassCard, {
					className: "p-5",
					children: [
						/* @__PURE__ */ jsx(I, { className: "h-5 w-5 text-primary" }),
						/* @__PURE__ */ jsx("h3", {
...
function WhatWeDo() {
	return /* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx(SectionHeading, {
			eyebrow: "What we do",
			title: /* @__PURE__ */ jsxs(Fragment, { children: ["Eight disciplines.", /* @__PURE__ */ jsx("span", {
				className: "text-gradient",
		...
		children: pillars.map(({ icon: I, title, desc }, i) => /* @__PURE__ */ jsx("div", {
			"data-reveal": true,
			className: "reveal",
			...
			children: /* @__PURE__ */ jsxs(GlassCard, {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: ["Learn more ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3" })]
					})
				]
			})
		}, title))
...
function FeaturedEvents() {
	return /* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(SectionHeading, {
			...
			children: ["All events ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 transition-transform group-hover:translate-x-0.5" })]
		})]
	}), /* @__PURE__ */ jsx("div", {
		className: "mt-12 grid gap-5 md:grid-cols-3",
		children: events.map((e, i) => /* @__PURE__ */ jsxs("article", {
			"data-reveal": true,
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(CalendarDays, { className: "h-14 w-14 text-white/70" })
					}),
					/* @__PURE__ */ jsx("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("span", { children: e.date }),
							/* @__PURE__ */ jsx("span", { children: "·" }),
							/* @__PURE__ */ jsx("span", { children: e.city })
						]
					}),
					/* @__PURE__ */ jsx("h3", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: ["Reserve seat ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3" })]
					})
				]
			})]
		}, e.title))
...
function Stats() {
	...
	return /* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: stats.map((s) => /* @__PURE__ */ jsx(StatItem, {
				...s,
				active
			}, s.label))
		})
...
function Timeline() {
	return /* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsx("div", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute left-4 sm:left-1/2 top-0 bottom-0 w-px -translate-x-1/2 bg-gradient-to-b from-transparent via-primary/60 to-transparent" }), /* @__PURE__ */ jsx("ol", {
			...
			children: timeline.map((t, i) => {
				...
				return /* @__PURE__ */ jsxs("li", {
					...
					children: [/* @__PURE__ */ jsx("div", { className: `hidden sm:block ${right ? "order-2" : ""}` }), /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: /* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-white" })
...
function FeaturedProjects() {
	return /* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsx("div", {
		...
		children: projects.map((p, i) => /* @__PURE__ */ jsxs(GlassCard, {
			className: "p-8",
			"data-reveal": true,
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						children: p.stack
					}), /* @__PURE__ */ jsx("span", { children: "· open-source" })]
				}),
				/* @__PURE__ */ jsx("h3", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: ["Explore project ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
				})
			]
		}, p.name))
	})] });
...
function Research() {
	return /* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			className: "reveal",
			children: [
				/* @__PURE__ */ jsx(Eyebrow, { children: "Research" }),
				/* @__PURE__ */ jsxs("h2", {
					className: "mt-5 font-display text-4xl sm:text-5xl font-semibold tracking-tight text-balance",
					children: [
						"Papers, replications & ",
...
function GalleryPreview() {
	return /* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(SectionHeading, {
			...
			children: ["Open gallery ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
		})]
	}), /* @__PURE__ */ jsx("div", {
...
function Testimonials() {
	return /* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsx("div", {
		...
		children: testimonials.map((t, i) => /* @__PURE__ */ jsxs(GlassCard, {
			className: "p-7",
			"data-reveal": true,
			style: { transitionDelay: `${i * 80}ms` },
			children: [
				/* @__PURE__ */ jsx(Quote, { className: "h-6 w-6 text-primary" }),
				/* @__PURE__ */ jsxs("p", {
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: Array.from({ length: 5 }).map((_, k) => /* @__PURE__ */ jsx(Star, { className: "h-3.5 w-3.5 fill-primary text-primary" }, k))
				})
			]
		}, t.name))
	})] });
...
function Partners() {
	...
	return /* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: [...logos, ...logos].map((l, i) => /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(School, { className: "h-5 w-5" }), l]
			}, i))
		})
	})] });
}
	...
	return /* @__PURE__ */ jsx(Section, { children: /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [
				/* @__PURE__ */ jsx("div", {
					className: "flex justify-center",
					children: /* @__PURE__ */ jsx(Eyebrow, { children: "Stay in orbit" })
				}),
				/* @__PURE__ */ jsxs("h2", {
					className: "mt-5 font-display text-4xl sm:text-5xl font-semibold tracking-tight text-balance",
					children: [
